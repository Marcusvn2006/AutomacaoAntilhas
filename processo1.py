...
def preencher_praia(
    ...
    esc(n, 27, vz(aux("00000000094682", n)))
    ...
    esc(n, 88,  vz(vds("00000000094688", n)))
    esc(n, 93,  vz(vds("00000000094682", n)))
...
def preencher_jau(
    ...
    esc(n, 100, vz(vds("00000000094688", n)))
...
def preencher_bauru(
    ...
    esc(n, 73,  vz(vds("00000000094688", n)))
    esc(n, 76,  vz(vds("00000000089713", n)))
    esc(n, 78,  vz(vds("00000000094682", n)))
    esc(n, 81,  vz(vds("00000000085706", n)))
    esc(n, 82,  vz(vds("00000000094959", n)))
    esc(n, 83,  vz(vds("00000000095150", n)))
    esc(n, 84,  vz(vds("00000000085705", n)))
    ...
    esc(n, 77,  vz(vds("00000000053655", n)))
    esc(n, 78,  vz(vds("00000000053656", n)))
    esc(n, 83,  vz(vds("00000000094688", n)))
    esc(n, 88,  vz(vds("00000000094682", n)))
